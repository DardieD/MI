...
EMAIL_USE_TLS = False
EMAIL_HOST = 'systers-dev.systers.org'
EMAIL_HOST_USER = ''
EMAIL_HOST_PASSWORD = ''
EMAIL_PORT = 25
...
DATABASES = {
    'default': {
        ...
        'NAME': '/vagrant/MI/mi_database.db',   # Or path to database file if using sqlite3.
...
SECRET_KEY = 'g9lvgdo39!2mh2$dbjrlfxm2k8*qs3g*%4r^+f26z@dff%t-71'
